...
let allOptions = {
  ...
  axisColor         : { string },
  backgroundColor   : { __type__: { string, object} },
  xBarWidth         : { number },
  yBarWidth         : { number },
  cameraPosition    : {
    distance  : { number },
  ...
  height: { string },
  width: { string },
  __type__: { object },		// TODO this should be the final item in options; remove the comma when done

//
// Options copied from 'network' - TODO remove these!
//
  configure: {
