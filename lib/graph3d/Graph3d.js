...
Graph3d.prototype._dataInitialize = function(rawData, style) {
  this.dataGroup.dataInitialize(this, rawData, style);
...
/**
 * Create a list with all present x values
 */
Graph3d.prototype.getPresentXValues = function(data) {
  var dataX = [];

  for (var i = 0; i < this.getNumberOfRows(data); i++) {
    var x = data[i][this.colX] || 0;
...
/**
 * Create a list with all present y values
 */
Graph3d.prototype.getPresentYValues = function(data) {
  var dataY = [];

  for (var i = 0; i < this.getNumberOfRows(data); i++) {
    var y = data[i][this.colY] || 0;
