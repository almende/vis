...
/**
 * Get the min/max values for the passed data column.
 *
 * Result is returned as a Range instance with min/max members
 * properly set.
 */
Graph3d.prototype.getColumnRange = function(data,column) {
  var range  = new Range();

  // Adjust the range so that it covers all values in the
  // passed data elements.
  for (var i = 0; i < data.length; i++) {
