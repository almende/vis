...
Graph3d.prototype._getDataPoints = function(data) {
  return this._graphHandler.getDataPoints(this, data);
}
...
Graph3d.prototype._readData = function(data) {
  ...
  if (this.dataFilter) {
    ...
    this.dataPoints = this._graphHandler.getDataPoints(this, this.dataTable);
...
Graph3d.prototype._redrawLegend = function() {
  ...
  this._graphHandler.drawLegend(this, ctx);
};
...
Graph3d.prototype._dataPointFromXY = function (x, y) {
  return this._graphHandler.dataPointFromXY(this, x, y);
};
