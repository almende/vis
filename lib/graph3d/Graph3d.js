...
// Style Handlers
//
// Source for settings up classes:
//
...
MatrixStyleHandler.prototype.getDataPoints = function(graph3D, data) {
	return graph3D._getDataPointsMatrix(data);
};

function PointStyleHandler() {
}

PointStyleHandler.prototype.getDataPoints = function(graph3D, data) {
	return graph3D._getDataPointsPoints(data);
};
...
DotStyleHandler.prototype = Object.create(PointStyleHandler.prototype);
DotStyleHandler.prototype.constructor = DotStyleHandler;

function DotLineStyleHandler() {
	PointStyleHandler.call(this);
}
DotLineStyleHandler.prototype = Object.create(PointStyleHandler.prototype);
DotLineStyleHandler.prototype.constructor = DotLineStyleHandler;

function DotColorStyleHandler() {
	PointStyleHandler.call(this);
}
DotColorStyleHandler.prototype = Object.create(PointStyleHandler.prototype);
DotColorStyleHandler.prototype.constructor = DotColorStyleHandler;

function DotSizeStyleHandler() {
	PointStyleHandler.call(this);
}
DotSizeStyleHandler.prototype = Object.create(PointStyleHandler.prototype);
DotSizeStyleHandler.prototype.constructor = DotSizeStyleHandler;

function LineStyleHandler() {
	PointStyleHandler.call(this);
}
LineStyleHandler.prototype = Object.create(PointStyleHandler.prototype);
LineStyleHandler.prototype.constructor = LineStyleHandler;

function GridStyleHandler() {
	MatrixStyleHandler.call(this);
}
GridStyleHandler.prototype = Object.create(MatrixStyleHandler.prototype);
GridStyleHandler.prototype.constructor = GridStyleHandler;

function SurfaceStyleHandler() {
	MatrixStyleHandler.call(this);
}
SurfaceStyleHandler.prototype = Object.create(MatrixStyleHandler.prototype);
SurfaceStyleHandler.prototype.constructor = SurfaceStyleHandler;

function BarStyleHandler() {
	PointStyleHandler.call(this);
}
BarStyleHandler.prototype = Object.create(PointStyleHandler.prototype);
BarStyleHandler.prototype.constructor = BarStyleHandler;

function BarColorStyleHandler() {
	PointStyleHandler.call(this);
}
BarColorStyleHandler.prototype = Object.create(PointStyleHandler.prototype);
BarColorStyleHandler.prototype.constructor = BarColorStyleHandler;

function BarSizeStyleHandler() {
	PointStyleHandler.call(this);
}
BarSizeStyleHandler.prototype = Object.create(PointStyleHandler.prototype);
BarSizeStyleHandler.prototype.constructor = BarSizeStyleHandler;
...
function Graph3d(container, data, options) {
  ...
  this.style           = Graph3d.STYLE.DOT;
	this._styleHandler   = this._getStyleHandler(this.style);
...
Graph3d.prototype._convertPointToTranslation = function(point3d) {
  ...
  // calculate translation
    factor0 = (sinTz * (ay - cy) + cosTz * (ax - cx)),
    factor1 = (cosTy * (az - cz) + sinTy * factor0),
    factor2 = (cosTz * (ay - cy) - sinTz * (ax - cx)),

    dx      = cosTy * factor0 - sinTy * (az - cz),
    dy      = sinTx * factor1 + cosTx * factor2,
    dz      = cosTx * factor1 - sinTx * factor2;
...
Graph3d.prototype._getStyleHandler = function(style) {
  switch (style) {
    case Graph3d.STYLE.DOT     : return new DotStyleHandler();
    case Graph3d.STYLE.DOTLINE : return new DotlineStylehandler();
    case Graph3d.STYLE.DOTCOLOR: return new DotColorStyleHandler();
    case Graph3d.STYLE.DOTSIZE : return new DotSizeStyleHandler();
    case Graph3d.STYLE.LINE    : return new LineStyleHandler();
    case Graph3d.STYLE.GRID    : return new GridStyleHandler();
    case Graph3d.STYLE.SURFACE : return new SurfaceStyleHandler();
    case Graph3d.STYLE.BAR     : return new BarStyleHandler();
    case Graph3d.STYLE.BARCOLOR: return new BarColorStyleHandler();
    case Graph3d.STYLE.BARSIZE : return new BarSizeStyleHandler()
  }
...
Graph3d.prototype._getDataPointsMatrix = function (data) {
...
// 'dot', 'dot-line', etc.
Graph3d.prototype._getDataPointsPoints = function (data) {
  var i, obj, point;
  var dataPoints = [];
...
Graph3d.prototype._getDataPoints = function (data) {
	console.log("Called Graph3d.prototype._getDataPoints()");
	return this._styleHandler.getDataPoints(this, data);
};
...
Graph3d.prototype.setOptions = function (options) {
  ...
  if (options !== undefined) {
    ...
    if (options.style !== undefined) {
			// WRI TODO: change style handler here as well
