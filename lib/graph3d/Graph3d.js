...
Graph3d.prototype._dataInitialize = function (rawData, style) {
  ...
  xRange.override(this.defaultXMin, this.defaultXMax);
  this.xRange = xRange;
  ...
  yRange.override(this.defaultYMin, this.defaultYMax);
  this.yRange = yRange;
  this.yStep = (this.defaultYStep !== undefined) ? this.defaultYStep : yRange.range()/NUMSTEPS;

  var zRange = this.getColumnRange(data, this.colZ);
  zRange.override(this.defaultZMin, this.defaultZMax);
  this.zRange = zRange;
  ...
  if (data[0].hasOwnProperty('style')) {
    ...
    valueRange.override(this.defaultValueMin, this.defaultValueMax);
