...
Graph3d.prototype._showTooltip = function (dataPoint) {
  ...
  var left = dataPoint.screen.x - contentRect.width / 2;
  left = Math.min(Math.max(left, 10), this.frame.clientWidth - 10 - contentRect.width);

  line.style.left   = dataPoint.screen.x + 'px';
  line.style.top    = (dataPoint.screen.y - lineRect.height) + 'px';
  content.style.left  = left + 'px';
  content.style.top   = (dataPoint.screen.y - lineRect.height - contentRect.height) + 'px';
  dot.style.left    = (dataPoint.screen.x - dotRect.width / 2) + 'px';
  dot.style.top     = (dataPoint.screen.y - dotRect.height / 2) + 'px';
};
