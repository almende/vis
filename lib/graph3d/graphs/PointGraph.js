...
support.derive(PointGraph, BaseGraph);


PointGraph.prototype.getDotSize = function(graph3d) {
 ...
 */
PointGraph.prototype.redraw = function(graph3d, ctx, points) {
...
PointGraph.prototype._calcRadius = function(graph3d, point, size) {
  var radius;
...
PointGraph.prototype.getColor = function(graph3d, point) {
...
PointGraph.prototype.redrawPoint = function(graph3d, ctx, point, size) {
