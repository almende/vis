...
/**
 * Define class 'child' as child class of 'parent'.
 *
 * Expressly not using Object.create() here, for better backward compatibility.
 * (Object.create() was introduced in ECMAScript5)
 */
...
function copy(src, dst, fields) {
  if (fields === undefined) {
    throw new Error('Parameter fields required');
  }
