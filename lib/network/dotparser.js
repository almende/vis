  ...
  if (attr_names.includes('dir')) {
    ...
    if (dir_type === 'both') {
      ...
      if (idx.arrows.to && idx.arrows.from) {
        var to_type = attr_list[idx.arrows.to].value.to.type;
        var from_type = attr_list[idx.arrows.from].value.from.type;
      ...
      if (idx.arrows.to) {
        ...
        var i = idx.arrows.from;
      }

      attr_list[i] = {
        'attr': attr_list[i].attr,
        'name': attr_list[i].name,
        'value': ''
      };
