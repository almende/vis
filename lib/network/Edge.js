...
Edge.prototype._label = function (ctx, text, x, y) {
  if (text) {
	...
	// Align according to the labelAlignment
	if(this.options.labelAlignment == 'line-center' || this.options.labelAlignment == 'line-above'){
	
		ctx.save();
		ctx.translate(x, this.labelDimensions.yLine);
		...
		console.log("ANGLE " + angleInDegrees + " X " + deltaX + " Y " + deltaY);
