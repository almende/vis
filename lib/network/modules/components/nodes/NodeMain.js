...
Node.prototype.setOptions = function(options, constants) {
  ...
  var fields = ['borderWidth', 'borderWidthSelected', 'shape', 'image', 'brokenImage', 'radius', 'label',
    'customScalingFunction', 'icon', 'value','hidden','physics'
  ];
  util.selectiveDeepExtend(fields, this.options, options);

  // basic options
  if (options.id !== undefined)        {this.id = options.id;}
  if (options.label !== undefined)     {this.label = options.label; this.originalLabel = options.label;}
  ...
  if (options.level !== undefined)     {this.level = options.level; this.preassignedLevel = true;}

  // navigation controls options
  if (options.horizontalAlignLeft !== undefined) {this.horizontalAlignLeft = options.horizontalAlignLeft;}
  if (options.verticalAlignTop    !== undefined) {this.verticalAlignTop    = options.verticalAlignTop;}
  if (options.triggerFunction     !== undefined) {this.triggerFunction     = options.triggerFunction;}
  ...
  if (options.radius !== undefined)         {this.baseRadiusValue = this.options.radius;}
  if (options.color !== undefined)          {this.options.color = util.parseColor(options.color);}
