...
class EdgeBase {
  ...
  getDistanceToEdge(x1, y1, x2, y2, x3, y3, via, values) {  // eslint-disable-line no-unused-vars
    ...
    // This is **wrong**! It doesn't take into account labels which are displayed rotated.
    // It only works for horizontal labels.
    // In addition, it's in violation of what this method is supposed to do.
