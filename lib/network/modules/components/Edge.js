...
class Edge {
  ...
  getFormattingValues() {
    ...
    let hasColor = this.options.color.hasOwnProperty('color');
    let values = {
      toArrow: toArrow,
      ...
      color: (hasColor? this.options.color.color : undefined),
      inheritsColor: (hasColor? false : this.options.color.inherit),
