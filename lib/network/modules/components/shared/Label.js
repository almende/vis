...
class Label {
  ...
  /**
   * Set the font option values, converting representation if required.
   *
   * This method is not used internally any more 
   *
  ...
  propagateFonts(pile) {
    ...
    */
    ...
    // Note that neither this.elementOptions nor this.fontOptions are used here!!!!
