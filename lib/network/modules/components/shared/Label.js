...
class Label {
  ...
  initFontOptions(options) {
    let newFont = options.font;  // Only this member used!
  ...
  propagateFonts(pile) {
     ...
     */
    let addFontToPile = (options, isFontOption = false) => {
    ...
    */
    let getFontOption = (multiName, option) => {
      let multiFont;
