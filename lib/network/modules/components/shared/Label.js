    ...
    if (this.elementOptions.label !== undefined) {
      ...
      if (this.elementOptions.font.multi) {
              ...
              if (this.fontOptions.maxWdt > 0) {
                ...
                while (w < words.length) {
                  ...
                  if ((lineWidth + measure.width > this.fontOptions.maxWdt) && (lastMeasure.width != 0)) {
                    ...
                    lines.add(k, text, lastMeasure.width, values.height, values, blocks[j].mod);
                    ...
                    if (w === words.length-1) {
                      ...
                      lines.add(k, text, measure.width, values.height, values, blocks[j].mod);
                ...
                lines.addAndAccumulate(k, blocks[j].text, measure.width, values.height, values, blocks[j].mod);
                width = lines[k].width > width ? lines[k].width : width;
        ...
        let addText = function(k, text, in_width, values) {
          ...
          // Hence the need to rename param 'in_width'.
