 ...
 * @typedef {{nodeId:(string|number)}} nodeClickItem
 * @typedef {{nodeId:(string|number), labelId:(string|number}} nodeLabelClickItem
 * @typedef {{edgeId:(string|number)}} edgeClickItem
 * @typedef {{edgeId:(string|number), labelId:(string|number}} edgeLabelClickItem
 */
...
class ComponentUtil {
  ...
  static pointInRect(rect, point, rotationPoint) {
    if (rotationPoint !== undefined && rotationPoint.angle !== 0) {
