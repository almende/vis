 ...
 * @typedef {{nodeId:id}} nodeClickItem
 * @typedef {{nodeId:id, labelId:id} nodeLabelClickItem
 * @typedef {{edgeId:id}} edgeClickItem
 * @typedef {{edgeId:id, labelId:id} edgeLabelClickItem
 */
