...
class NavigationHandler {
  ...
  _zoomIn()   {
      ...
      var tx = (1 - scaleFrac) * this.canvas.OriginalViewCenter.x + translation.x * scaleFrac;
      var ty = (1 - scaleFrac) * this.canvas.OriginalViewCenter.y + translation.y * scaleFrac;
