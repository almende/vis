...
class Node {
  ...
  setOptions(options) {
    ...
    if (this.id === undefined) {
      throw Error("Node must have an id");
    }
  ...
  _load_images() {
    ...
    if (this.options.image === undefined) {
      throw Error("Option image must be defined for node type '" + this.options.shape + "'");
    }

    if (this.imagelist === undefined) {
      throw Error("Internal Error: No images provided");
    }
    ...
    if (typeof this.options.image === 'string') {
      ...
      if (this.options.image.unselected === undefined) {
        throw Error("No unselected image provided");
      }
