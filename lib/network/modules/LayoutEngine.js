 ...
 * to the block-shifting algorithm. This assumes formal trees and fails for not-trees, often
      ...
      for (let i = 0; i < levels.length; i++) {
        ...
        if (levelNodes.length > 1) {
          for (let j = 0; j < levelNodes.length - 1; j++) {
            ...
            // NOTE: logic copied as is; if nodes have same ancestor, then of course they are
