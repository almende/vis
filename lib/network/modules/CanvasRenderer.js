...
class CanvasRenderer {
  ...
  _drawSelectionBox(ctx /* x0, y0, x1, y1 */) {
    ctx.save();
    {
      ctx.rect(this.body.selectionBox.x, this.body.selectionBox.y, this.body.selectionBox.width, this.body.selectionBox.height);
      ctx.stroke();

      //ctx.fillStyle = "rgba(0, 0, 0, 0.25)";
      //ctx.fillRect(canvasRectModelCoords.x + 1, canvasRectModelCoords.y + 1, 98, 98);
    }
    ctx.restore();
  }
