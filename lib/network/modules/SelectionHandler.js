...
class SelectionHandler {
  ...
  constructor(body, canvas) {
    this.body = body;
    this.canvas = canvas;
    this.insertionOrderSelectionObj = {nodes: [], edges: []};
  ...
  setOptions(options) {
    if (options !== undefined) {
      let fields = ['multiselect', 'sortMultiselect', 'hoverConnectedEdges','selectable','selectConnectedEdges'];
   ...
   */
  _addToSelection(obj) {
    if (!this.options.sortMultiselect) {
      if (obj instanceof Node) {
        this.insertionOrderSelectionObj.nodes.push(obj);
      }
      else {
        this.insertionOrderSelectionObj.edges.push(obj);
      }
    }
  ...
  _removeFromSelection(obj) {
    if (!this.options.sortMultiselect) {
      let index = this.insertionOrderSelectionObj.nodes.indexOf(obj);
      this.insertionOrderSelectionObj.splice(index, 1);
    }
   ...
   */
  unselectAll() {
    this.insertionOrderSelectionObj.nodes = [];
    this.insertionOrderSelectionObj.edges = [];
  ...
  getSelectedNodes() {
    if (!this.options.sortMultiselect) {
      let result = [];
      for (let element of this.insertionOrderSelectionObj.nodes) {
  ...
  getSelectedEdges() {
    if (!this.options.sortMultiselect) {
      let result = [];
      for (let element of this.insertionOrderSelectionObj.edges) {
        result.push(element.id);
      }
      return result;
    }
