...
class InteractionHandler {
  ...
  setOptions(options) {
    if (options !== undefined) {
      ...
      // (there is an overlap between the responsibilites of Network's CanvasRenderer, InteractionHandler and SelectionHandler
      let fields = [
  ...
  onDrag(event) {
    ...
    if (this.selectionBox.isActive()) {
      ...
      this.selectionBox.updateBoundingBox(p)
