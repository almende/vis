...
class InteractionHandler {
  ...
  onContext(event) {
    ...
    const hoveredElements = {
      nodes: (this.selectionHandler.getNodeAt(pointer) || []),
      edges: (this.selectionHandler.getEdgeAt(pointer) || [])
    }
    hoveredElements.nodes = [].concat(hoveredElements.nodes)
    hoveredElements.edges = [].concat(hoveredElements.edges)
    this.selectionHandler._generateClickEvent('oncontext', Object.assign({}, event, hoveredElements), pointer);
  }
