...
//////////////////////////////////////////////////////////////////////////////
  ...
  items.forEach(function(item) {
    ...
    item.addEventListener('dragenter', handleDragEnter.bind(this), false)
    item.addEventListener('drag', handleDrag.bind(this), false)
    item.addEventListener('dragover', handleDragOver.bind(this), false);
    item.addEventListener('dragleave', handleDragLeave.bind(this), false);
