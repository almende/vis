...
Core.prototype.setOptions = function (options) {
  if (options) {
    ...
    var fields = [
      ...
      'locale', 'locales', 'moment', 'rtl', 'verticalScroll'
    ];
...
Core.prototype._redraw = function() {
  ...
  props.left.width = dom.leftContainer.clientWidth + scrollbarWidth   || -props.border.left;
  props.right.width = dom.rightContainer.clientWidth + scrollbarWidth || -props.border.right;
