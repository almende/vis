...
Core.prototype._redraw = function() {
  ...
  window.a = this.dom.leftContainer;
  console.log(props);
  // console.log(dom.centerContainer, dom.centerContainer.style.height);

  if (!this.options.verticalScroll ||  props.center.height < props.centerContainer.height) {
