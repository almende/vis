...
Core.prototype._create = function (container) {
  ...
  this.dom.dragSource           = document.getElementsByClassName('vis-drag-source');
...
//////////////////////////////////////////////////////////////////////////////
  ...
  // console.log(this.dom.dragSource);
  // this.dom.dragSource[0].addEventListener("dragstart", onDragstart.bind(this), false);
  ...
  // this.dom.dragSource[0].forEach().addEventListener("drag", onDrag.bind(this), true);

  // this.dom.dragSource[0].addEventListener("drop", onDrop.bind(this), false);

  // this.dom.root.addEventListener("mouseup", onMouseup.bind(this), false);

  // this.dom.root.addEventListener("dragend", onDragend.bind(this), false);


  // function onMouseover (event) {
  //   console.log("mouse in");
  // }
  // this.dom.center.addEventListener("mouseover", onMouseover.bind(this), false);


  // function onMouseenter (event) {
  //   console.log("mouse entered");
  // }
  // this.dom.center.addEventListener("mouseenter", onMouseenter.bind(this), true);


  // function onMouseleave (event) {
  //   console.log("mouse leave");
  // }
  // this.dom.center.addEventListener("mouseleave", onMouseleave.bind(this), true);
...
this.dom.center.addEventListener("dragover", function(event) {
  console.log("aaaaa");
  event.preventDefault();
});
this.dom.center.addEventListener('drop', handleDrop, false);
///////////////////////////////////////////////////////////////////////////////
