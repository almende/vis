...
Core.prototype._create = function (container) {
  ...
  this.dom.rollingModeBtn       = document.createElement('div');
   ...
   // Moshe's code
    ...
    this.dom.rightZone            = document.createElement('div');

    this.dom.leftZone.className = 'leftZone';
    this.dom.rightZone.className = 'rightZone';

    this.mouseLocation = {mouseOnLeft: false, mouseOnRight: false}
    var that = this;

    this.dom.leftZone.onmouseenter = function(){that.mouseLocation.mouseOnLeft = true;}
    this.dom.leftZone.onmouseleave = function(){that.mouseLocation.mouseOnLeft = false;}

    this.dom.rightZone.onmouseenter = function(){that.mouseLocation.mouseOnRight = true;}
    this.dom.rightZone.onmouseleave = function(){that.mouseLocation.mouseOnRight = false;}
  ...
  // moshe`s code
    ...
    this.dom.centerContainer.appendChild(this.dom.leftZone);
    this.dom.centerContainer.appendChild(this.dom.rightZone);
  //
