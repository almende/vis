...
Core.prototype.setOptions = function (options) {
  if (options) {
    ...
    var fields = [
      ...
      'locale', 'locales', 'moment', 'noPanelTop',
      'throttleRedraw'
    ];
...
Core.prototype._redraw = function() {
  ...
  if (this.options.noPanelTop != 'both' && this.options.noPanelTop != 'top') {
	dom.top.style.top                   = '0';
  }
  dom.bottom.style.left               = props.left.width + 'px';
  if (this.options.noPanelTop != 'both' && this.options.noPanelTop != 'bottom') {
