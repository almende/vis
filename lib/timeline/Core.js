...
//////////////////////////////////////////////////////////////////////////////
  ...
  function handleDrop(event) {
    var itemData;
    try {
      itemData = JSON.parse(event.dataTransfer.getData("text/plain"))
    } catch (err) {
      return
    }
    
    var isValidItemData = itemData.type && itemData.id && itemData.content;

    if (!isValidItemData) return
    ...
    // me.itemSet._onDragStartAddItem(event);
