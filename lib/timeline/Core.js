...
Core.prototype._create = function (container) {
  ...
  this.dom.sideContainer        = document.createElement('div');
  this.dom.center               = document.createElement('div');
  this.dom.left                 = document.createElement('div');
  this.dom.right                = document.createElement('div');
  this.dom.side                 = document.createElement('div');
  ...
  this.dom.sideContainer.className        = 'vis-panel vis-side';
  this.dom.top.className                  = 'vis-panel vis-top';
  this.dom.bottom.className               = 'vis-panel vis-bottom';
  this.dom.left.className                 = 'vis-content';
  this.dom.center.className               = 'vis-content';
  this.dom.right.className                = 'vis-content';
  this.dom.side.className                 = 'vis-content';
  ...
  this.dom.root.appendChild(this.dom.sideContainer);
  ...
  this.dom.sideContainer.appendChild(this.dom.side);
  ...
  this.dom.sideContainer.appendChild(this.dom.shadowTopRight);
  this.dom.sideContainer.appendChild(this.dom.shadowBottomRight);
...
Core.prototype.setOptions = function (options) {
  if (options) {
    ...
    if (this.options.verticalScroll) {
      ...
      this.dom.sideContainer.className = 'vis-panel vis-side vis-vertical-scroll';
    }
...
Core.prototype._redraw = function() {
  ...
  props.border.side  = props.border.left;
  ...
  props.side.height  = dom.side.offsetHeight;
  ...
  var contentHeight = Math.max(props.left.height, props.center.height, props.right.height, props.side.height);
  ...
  props.sideContainer.height   = props.leftContainer.height;
  ...
  if (options.verticalScroll) {
    if (options.rtl) {
      ...
      props.side.width = dom.sideContainer.clientWidth + props.scrollbarWidth || -props.border.side;
    } else {
      props.left.width = dom.leftContainer.clientWidth + props.scrollbarWidth || -props.border.left;
      props.right.width = dom.rightContainer.clientWidth || -props.border.right;
      props.side.width = dom.sideContainer.clientWidth || -props.border.side;
    }
  } else {
    props.left.width = dom.leftContainer.clientWidth  || -props.border.left;
    props.right.width = dom.rightContainer.clientWidth || -props.border.right;
  ...
  if (options.verticalScroll) {
    ...
    dom.sideContainer.className = 'vis-panel vis-side vis-vertical-scroll';
  ...
  if (!options.verticalScroll ||  props.center.height < props.centerContainer.height) {
    ...
    dom.sideContainer.className = dom.sideContainer.className.replace(new RegExp('(?:^|\\s)'+ 'vis-vertical-scroll' + '(?:\\s|$)'), ' ');
    props.left.width = dom.leftContainer.clientWidth  || -props.border.left;
    props.right.width = dom.rightContainer.clientWidth || -props.border.right;
    props.side.width = dom.sideContainer.clientWidth || -props.border.side;
    this._setDOM();
...
Core.prototype._setDOM = function () {
  ...
  props.sideContainer.width = props.side.width;
  var centerWidth = props.root.width - props.left.width - props.right.width - props.side.width - props.borderRootWidth;
  ...
  dom.sideContainer.style.height        = props.sideContainer.height + 'px';
  ...
  dom.sideContainer.style.left        = (props.left.width + props.center.width + props.right.width) + 'px';
  dom.sideContainer.style.top         = props.top.height + 'px';
...
Core.prototype._onDrag = function (event) {
  ...
  if (this.options.verticalScroll) {
    ...
    this.dom.side.parentNode.scrollTop = -this.props.scrollTop;
  }
