...
Core.prototype._create = function (container) {
  ...
  function onMouseScrollCenter(event) {
    var current = $(this).scrollTop();
    var adjusted = current - 2.5;
    $('.vis-left>.vis-content').scrollTop(adjusted);
    $('.vis-right>.vis-content').scrollTop(adjusted);
  ...
  this.dom.left.addEventListener('scroll', onMouseScrollSide);
  this.dom.right.addEventListener('scroll', onMouseScrollSide);
  this.dom.center.addEventListener('mousewheel', onMouseScrollCenter);
  this.dom.center.addEventListener('DOMMouseScroll', onMouseScrollCenter);
