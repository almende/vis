...
Core.prototype._redraw = function() {
  ...
  var loadingTime = new Date() - this.initTime.getTime();
  if ( this.options.onTimeout && loadingTime > this.options.onTimeout.timeoutMs  && !this.initialDrawDone) {
    this.destroy();
    return this.options.onTimeout.callback()
  }
