...
Core.prototype._redraw = function() {
  ...
  var centerContainerRect = dom.centerContainer.getBoundingClientRect();
  props.border.left   = (centerContainerRect.width - dom.centerContainer.clientWidth) / 2;
  props.border.right  = props.border.left;
  props.border.top    = (centerContainerRect.height - dom.centerContainer.clientHeight) / 2;
  props.border.bottom = props.border.top;
  var rootRect = dom.root.getBoundingClientRect();
  var borderRootHeight= rootRect.height - dom.root.clientHeight;
  var borderRootWidth = rootRect.width - dom.root.clientWidth;
  ...
  props.center.height = dom.center.getBoundingClientRect().height;
  props.left.height   = dom.left.getBoundingClientRect().height;
  props.right.height  = dom.right.getBoundingClientRect().height;
  ...
  props.root.height = rootRect.height;
  ...
  props.root.width = rootRect.width;
...
Core.prototype._startAutoResize = function () {
  ...
  this._onResize = function() {
    ...
    if (me.dom.root) {
      ...
      var rootRect = me.dom.root.getBoundingClientRect();
      if ((rootRect.width != me.props.lastWidth) ||
        (rootRect.height != me.props.lastHeight)) {
        me.props.lastWidth = rootRect.width;
        me.props.lastHeight = rootRect.height;
