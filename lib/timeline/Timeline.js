 ...
 *
 * @param {vis.Item} item
 * @return {{shouldScroll: Boolean, scrollOffset: int, itemTop: int}}
 */
function getItemVerticalScroll(timeline, item) {
  ...
  var groupId = item.data.group;
  var group = timeline.itemSet.groups[groupId] || { top: 0, height: 0 }; // Use a default if we don't have a group
