...
ItemSet.prototype._create = function(){
  ...
  // moshe's code
    ...
    this.setMouseOnLeft = function(isOn){
      ...
      context.setMouseLeave(false);
    }

    this.setMouseOnRight = function(isOn){
      context.mouseLocation.mouseOnRight = isOn;
      context.setMouseLeave(false);
    }

    this.setMouseLeave = function(isLeaveNow){
      if(context.mouseLocation.mouseOnLeft || context.mouseLocation.mouseOnRight)
      context.mouseLocation.mouseIsLeaving = isLeaveNow;

      // context.mouseLocation.mouseOnRight = context.mouseLocation.mouseOnLeft = false;
    }

    this.body.dom.leftZone.onmouseenter = this.body.dom.leftContainer.onmouseenter = function()
    {
...
ItemSet.prototype._onDrag = function (event) {
  // moshe's code
  if(this.mouseLocation.mouseOnLeft || this.mouseLocation.mouseOnRight){
        ...
        if (props.dragLeft) {
          ...
          if (itemData.start != undefined) {
            ...
            var start = new Date(initialStart + offset);
              ...
              if(this.mouseLocation.mouseOnLeft || this.mouseLocation.mouseOnRight || 
                this.mouseLocation.mouseIsLeaving){

                if(this.mouseLocation.mouseIsLeaving)console.log("mouse out from zone")
                ...
                { 
                  if(this.mouseLocation.mouseIsLeaving) console.log("end move")
                  start = windowStart;
                }

                 if(this.mouseLocation.mouseIsLeaving) {
                  this.mouseLocation.mouseOnLeft = this.mouseLocation.mouseOnRight = this.mouseLocation.mouseIsLeaving = false;
                 }
              }
