...
ItemSet.prototype._create = function(){
  ...
  // create sidelabelset
  var sideLabelSet = document.createElement('div');
  sideLabelSet.className = 'vis-sidelabelset';
  this.dom.sideLabelSet = sideLabelSet;
  ...
  this.sideHammer = new Hammer(this.body.dom.sideContainer);

  this.sideHammer.on('tap', this._onGroupClick.bind(this));
  this.sideHammer.get('pan').set({ threshold: 5, direction: Hammer.DIRECTION_VERTICAL });
...
ItemSet.prototype.setOptions = function(options) {
  if (options) {
    ...
    var fields = [
      ...
      'multiselectPerGroup', 'groupOrder', 'dataAttributes', 'template', 'groupTemplate', 'sideTemplate', 'visibleFrameTemplate',
...
ItemSet.prototype.hide = function() {
  ...
  // remove the sidelabelset containing all side labels
  if (this.dom.sideLabelSet.parentNode) {
    this.dom.sideLabelSet.parentNode.removeChild(this.dom.sideLabelSet);
  }
};
...
ItemSet.prototype.show = function() {
  ...
  // show sidelabelset containing labels
  if (!this.dom.sideLabelSet.parentNode) {
    this.body.dom.side.appendChild(this.dom.sideLabelSet);
  }
};
...
ItemSet.prototype.redraw = function() {
  ...
  this.props.side = this.body.domProps.side.width + this.body.domProps.border.side;
...
/**
 * Get the element for the sidelabelset
 * @return {HTMLElement} sideLabelSet
 */
ItemSet.prototype.getSideLabelSet = function() {
  return this.dom.sideLabelSet;
};
