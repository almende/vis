...
ItemSet.prototype._onDragStart = function (event) {
  ...
  var editableKeyActivated = event.srcEvent && (event.srcEvent.ctrlKey || event.srcEvent.metaKey);
  var draggedFromExternal = event.type.includes('drag');
  var me = this;
  var props;
  ...
  else if (this.options.editable.add && (editableKeyActivated || draggedFromExternal)) {
