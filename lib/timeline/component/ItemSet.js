...
ItemSet.prototype.redraw = function() {
  ...
  var changedStack = options.stack != this.lastStack
  var changedStackSubgroups = options.stackSubgroups != this.lastStackSubgroups
  var forceRestack = (zoomed || scrolled || changedStack || changedStackSubgroups);
