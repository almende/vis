...
ItemSet.prototype._create = function(){
  ...
  // this.touchParams = {mouseOnLeft: false, mouseOnRight: false, mouseIsLeaving: false}
  var context = this;

  this.setMouseOnLeft = function(isOn){
    context.touchParams.mouseOnLeft = isOn;
    context.setMouseLeave(false);
  }

  this.setMouseOnRight = function(isOn){
    context.touchParams.mouseOnRight = isOn;
    context.setMouseLeave(false);
  }

  this.setMouseLeave = function(isLeaveNow){
    context.touchParams.mouseIsLeaving = isLeaveNow;

    if((context.touchParams.mouseOnLeft || context.touchParams.mouseOnRight) && isLeaveNow) {
