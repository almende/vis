...
function ItemSet(body, options) {
  ...
  this.defaultOptions = {
    ...
    moveBefore: function(draggedGroup, targetGroup, groups) {
...
ItemSet.prototype.setOptions = function(options) {
  if (options) {
    ...
    var fields = ['type', 'align', 'order', 'stack', 'selectable', 'multiselect', 'groupOrder', 'dataAttributes', 'template', 'groupTemplate', 'hide', 'snap', 'moveBefore'];
	...
	if (this.options.groupEditable.order && this.groupTouchParams.group) {
		...
		if (group && group != this.groupTouchParams.group) {
			...
			if (draggedGroup && targetGroup) {
				this.options.moveBefore(draggedGroup, targetGroup, this.groupsData);
			}
			...
			if (!util.equalArray(newOrder, this.groupTouchParams.originalOrder)) {
				...
				while (curPos < numGroups) {
					...
					// not all ok -> since we start from the first group, did we reach the dragged group?
					if (newOrder[curPos+newOffset] == draggedId) {
						...
						this.options.moveBefore(switchGroup, shouldBeGroup, groupsData);
