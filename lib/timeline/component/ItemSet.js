...
ItemSet.prototype._create = function(){
  ...
  this.setMouseLeave = function(isLeaveNow){
    ...
    if((context.mouseLocation.mouseOnLeft || context.mouseLocation.mouseOnRight) && isLeaveNow) {
      if(context.dragEvent) ItemSet.prototype._onDragEnd.bind(context)(context.dragEvent);
      this.mouseLocation.mouseOnLeft = this.mouseLocation.mouseOnRight = false;
    }
...
ItemSet.prototype._onDrag = function (event) {
  if((this.mouseLocation.mouseOnLeft || this.mouseLocation.mouseOnRight) && this.touchParams.itemProps){
    ...
    if ((this.options.rtl && this.mouseLocation.mouseOnLeft) || (!this.options.rtl && this.mouseLocation.mouseOnRight)) {
