...
ItemSet.prototype._onGroupClick = function (event) {
  ...
  var nestedGroups = this.groupsData.get(group.nestedGroups).map(function(nestedGroup) {
    nestedGroup.visible = !nestedGroup.visible;
    return nestedGroup;
  });

  console.log(this.groupsData instanceof DataSet)
  this.groupsData.update(nestedGroups);
