...
BackgroundItem.prototype.repositionY = function(margin) {
  ...
  if (this.data.subgroup !== undefined) {
    ...
    if (orientation == 'top') { 
      this.dom.box.style.top = this.parent.subgroups[itemSubgroup].top + 'px';
    } else {
      this.dom.box.style.top = (this.parent.height - this.parent.subgroups[itemSubgroup].top - this.parent.subgroups[itemSubgroup].height - margin.item.vertical) + 'px';
    }
