...
PointItem.prototype.redraw = function() {
  ...
  if (this.dirty) {
    ...
    var dotRect = this.props.dot.getBoundingClientRect();
    this.props.dot.width = dotRect.width;
    this.props.dot.height = dotRect.height;
    this.props.content.height = dom.content.getBoundingClientRect().height;
    ...
    // recalculate size
    var pointRect = dom.point.getBoundingClientRect();
    this.width = pointRect.width;
    this.height = pointRect.height;
