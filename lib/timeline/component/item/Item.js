...
Item.prototype._updateContents = function (element) {
  ...
  var itemVisibleFrameContentElement = this.dom.box.getElementsByClassName('vis-item-visible-frame')[0];
  if (this.options.dynamicContentTemplate) {
    visibleFrameTemplateFunction = this.options.dynamicContentTemplate.bind(this);
    itemVisibleFrameContent = visibleFrameTemplateFunction(itemData, this.dom.box);
  } else {
  ...
  if ((itemVisibleFrameContent instanceof Object) && !(itemVisibleFrameContent instanceof Element)) {
    ...
    // if ((dynamicContentTemplate instanceof Object) && !(dynamicContentTemplate instanceof Element)) {
    //   dynamicContentTemplateFunction(itemData, this.dom.box)
    // } else {
    //   var changed = this._contentToString(this.dynamicContentTemplate) !== this._contentToString(dynamicContentTemplate);
    //   if (changed) {
    //     // only replace the content when changed
    //     if (dynamicContentTemplate instanceof Element) {
    //       dynamicContentTemplate.innerHTML = '';
    //       this.dom.box.appendChild(dynamicContentTemplate);
    //     }
    //     else if (dynamicContentTemplate != undefined) {
    //       dynamicContentTemplateElement.innerHTML = dynamicContentTemplate;
    //     }
    //     // else {
    //     //   if (!(this.data.type == 'background' && this.data.content === undefined)) {
    //     //     throw new Error('Property "content" missing in item ' + this.id);
    ...
    //     this.dynamicContentTemplate = dynamicContentTemplate;
    //   }
    // }
