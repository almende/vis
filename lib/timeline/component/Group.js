...
Group.prototype.redraw = function(range, margin, forceRestack) {
  ...
  resized = util.updateProperty(this.props.sideLabel, 'width', this.dom.sideInner.clientWidth) || resized;
  resized = util.updateProperty(this.props.sideLabel, 'height', this.dom.sideInner.clientHeight) || resized;
