  ...
  if (restack) {
    ...
    if (typeof this.itemSet.options.order === 'function') {
      ...
      if (this.doInnerStack && this.itemSet.options.stackSubgroups) {
        ...
        this.shouldBailStackItems = stack.stack(customOrderedItems, margin, true /* restack=true */, bailOptions, this.itemSet.initialItemSetDrawn);        
      }
      ...
      if (this.itemSet.options.stack) {
        if (this.doInnerStack && this.itemSet.options.stackSubgroups) {                    
          ...
          this.shouldBailStackItems = stack.stack(this.visibleItems, margin, true /* restack=true */, bailOptions, this.itemSet.initialItemSetDrawn);
        }
      } else {
        // no stacking
