...
function Group (groupId, data, itemSet) {
  ...
  this.isVisible = null;
  this.nestedGroups = data && data.nestedGroups || [];
  this.showNested = data && data.showNested || true;
...
Group.prototype._create = function() {
  ...
  collapseGroupBtn.style.display = 'none';
  this.dom.collapseGroupBtn = collapseGroupBtn;
  this.dom.label.appendChild(this.dom.collapseGroupBtn);
...
Group.prototype.setData = function(data) {
  ...
  if (data && data.nestedGroups) {
    if (data.showNested == undefined) {
      data.showNested = true;
    } 

    this.dom.collapseGroupBtn.style.display = "inline-block";
    if (data.showNested) {
      this.dom.collapseGroupBtn.innerHTML = '&#9660;';
      util.removeClassName(this.dom.label, 'collapsed');
    } else {
      this.dom.collapseGroupBtn.innerHTML = this.itemSet.options.rtl ? '&#9668' : '&#9658;';
