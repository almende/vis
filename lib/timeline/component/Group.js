...
Group.prototype._getGroupProperties = function() {
  return {
    top: this.dom.foreground.offsetTop,
    left: this.dom.foreground.offsetLeft,
    width: this.dom.foreground.offsetWidth
  }
}

Group.prototype._setGroupProperties = function(properties) {
  this.top = properties.top;
  this.right = properties.left;
...
Group.prototype.redraw = function(range, margin, forceRestack, returnQueue) {
  ...
  var height;
  var groupPropertiesBeforeUpdate, groupPropertiesAfterUpdate;
  ...
  var queue = [
    ...
    // get actual size and position
    (function() {
      groupPropertiesBeforeUpdate = this._getGroupProperties();
    }).bind(this),

    // set actual size and position
    (function() {
      this._setGroupProperties(groupPropertiesBeforeUpdate);
    }).bind(this),
    ...
    // get actual size and position
    (function() {
      groupPropertiesAfterUpdate = this._getGroupProperties();
    }).bind(this),

    // set actual size and position
    (function() {
      this._setGroupProperties(groupPropertiesAfterUpdate);
    }).bind(this),
