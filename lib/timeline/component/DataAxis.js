...
DataAxis.prototype.redraw = function () {
  ...
  if (this.amountOfGroups === 0 || activeGroups === 0) {
    ...
    var backgroundHorizontalRect = this.body.dom.backgroundHorizontal.getBoundingClientRect();
    props.minorLineWidth = backgroundHorizontalRect.width - this.lineOffset - this.width + 2 * this.options.minorLinesOffset;
    props.minorLineHeight = 1;
    props.majorLineWidth = backgroundHorizontalRect.width - this.lineOffset - this.width + 2 * this.options.majorLinesOffset;
...
DataAxis.prototype._redrawLabels = function () {
  ...
  if (this.master === true) {
    this.stepPixels = ((frameRect.height) / step.marginRange) * step.step;
    this.amountOfSteps = Math.ceil(frameRect.height / this.stepPixels);
  }
  else {
    // align with zero
